...
export default function NeueExportModal(props: ModalProps) {
  ...
  return (
    <BaseDialog isVisible={props.isVisible} onClose={props.onClose} isLockingScroll title={props.title}>
      <div style={{ width: 400 }}>
        <div
          style={{
        ...
        >
          ...
          <PrimaryButton label="Push to device" onClick={onClick} isLoading={isLoading} isDisabled={isLoading} />
        </div>
      </div>
    </BaseDialog>
  );
